"""
Django settings for nkkc_221 project.
...
WSGI_APPLICATION = 'nkkc_221.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nkkc_221 API",
    "DESCRIPTION": "API documentation for nkkc_221 App",
    "VERSION": "v1",
}
